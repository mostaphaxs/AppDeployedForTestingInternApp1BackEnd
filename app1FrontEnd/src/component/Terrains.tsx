                                    ...
                                    <div className="space-y-6">
                                        <div>
                                            ...
                                            <div className="space-y-2">
                                                <div className={`flex items-center justify-between p-4 rounded-2xl border transition-all ${selectedTerrain.autorisation_construction > 0 ? 'bg-emerald-50/50 border-emerald-100 text-emerald-700 shadow-sm shadow-emerald-50' : 'bg-gray-50 border-gray-100 text-gray-500'}`}>
                                                    <span className="text-[11px] font-black uppercase tracking-wider">Construction</span>
                                                    <span className="font-bold">{formatNumber(selectedTerrain.autorisation_construction || 0)} DH</span>
                                                </div>
                                                <p className="text-xs font-semibold text-gray-500 mb-1 uppercase tracking-wider">Autorisation d'équipement</p>
                                                <div className={`flex items-center justify-between p-4 rounded-2xl border transition-all ${selectedTerrain.autorisation_equipement > 0 ? 'bg-blue-50/50 border-blue-100 text-blue-700 shadow-sm shadow-blue-50' : 'bg-gray-50 border-gray-100 text-gray-500'}`}>
                                                    <Briefcase size={22} className={selectedTerrain.autorisation_equipement > 0 ? 'text-blue-500' : 'text-gray-400'} />
                                                    <span className="font-bold">{formatNumber(selectedTerrain.autorisation_equipement || 0)} DH</span>
                                                </div>
                                                <div className={`flex items-center justify-between p-4 rounded-2xl border transition-all ${selectedTerrain.frais_pompier > 0 ? 'bg-red-50/50 border-red-100 text-red-700 shadow-sm shadow-red-50' : 'bg-gray-50 border-gray-100 text-gray-500'}`}>
                                                    <span className="text-[11px] font-black uppercase tracking-wider">Pompier</span>
